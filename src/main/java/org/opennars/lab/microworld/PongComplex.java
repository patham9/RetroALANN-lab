...
public class PongComplex extends Frame {
    ...
    public class MyPapplet extends PApplet {
        ...
        class Hai
        {
            ...
            int UpdateSOM(float[] viewField,float reward) //input and reward
            {
                ...
                String pos = String.valueOf(((int)agent.x)/200);
                String posPaddle = String.valueOf(((int)ball.x)/200);
                System.out.println(pos);
                if(k%20 == 0) {
                    String agentPos = "<{" + pos + "} --> agentPos>. :|:";
                    String paddlePos = "<{" + posPaddle + "} --> paddlePos>. :|:";
                    nar.addInput(agentPos);
                    nar.addInput(paddlePos);
                }
